...
public class Login extends JFrame implements ActionListener {
    ...
    Login(){
        ...
        text.setBounds(200,40,600,40);//must be done becoz setLayout(null)
        add(text);
        
        JLabel cardno=new JLabel("CARD NO:");
        cardno.setFont(new Font("Osward", Font.BOLD, 28));
        cardno.setBounds(120,150,400,30);//must be done becoz setLayout(null)
        add(cardno);
        ...
        pin.setBounds(120,220,250,30);//must be done becoz setLayout(null)
        add(pin);
    ...
    public void actionPerformed(ActionEvent ae){
        if (ae.getSource()== clear){
            ...
            try{
              ...
              if(rs.next()){
                  setVisible(false);//successful login so close login pane and open transactions
